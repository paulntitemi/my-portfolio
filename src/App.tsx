      ...
      <div className="min-h-screen bg-background transition-colors duration-300">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              <div className="shrink-0">
                <h3 className="tracking-tight">Paul Nti</h3>
              </div>
        ...
        <footer className="bg-secondary/10 py-12 px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h3 className="mb-4">Paul Nti</h3>
            <p className="text-muted-foreground mb-6">
              Software Engineer | AI/ML Engineer | DevOps Enthusiast | Cloud Engineer
            </p>
            <p className="text-sm text-muted-foreground">
              © 2025 Paul Nti. All rights reserved.
            </p>
          </div>
        </footer>
      </div>
